                ...
                <div className="md:flex">
                  ...
                  <div className="md:w-1/2 p-8 bg-itve-white">
                    ...
                    <CardContent className="p-0">
                      ...
                      <p className="mt-4 font-semibold text-itve-blue-dark">Dr. Evelyn Reed, President & Founder</p>
                    </CardContent>
                  </div>
                </div>
              </Card>
            ...
            >
              <Card className="p-6 md:p-8 bg-itve-white shadow-lg rounded-lg">
                ...
                <CardContent className="p-0 space-y-4 text-itve-gray-dark">
                  <p>Founded in 2005 by Dr. Evelyn Reed, ITVE began with a single, modest campus and a grand vision: to bridge the critical skills gap in our nation by providing high-quality, accessible vocational training. Over the years, we've meticulously expanded our program offerings, continuously upgraded our campus facilities to state-of-the-art standards, and forged robust, mutually beneficial partnerships with key industry leaders.</p>
                  ...
                  <ul className="list-none space-y-3">
                    <li className="flex items-start">
                      ...
                      <div><span className="font-semibold text-itve-gray-dark">2005:</span> ITVE Established with a focus on foundational technical skills. First 50 students enrolled.</div>
                    </li>
                    <li className="flex items-start">
                      <Award className="h-5 w-5 mr-3 mt-1 text-itve-blue flex-shrink-0" />
                      <div><span className="font-semibold text-itve-gray-dark">2010:</span> Recognized as a National Center of Excellence for Vocational Training by the Ministry of Education.</div>
                    </li>
                    <li className="flex items-start">
                      <TrendingUp className="h-5 w-5 mr-3 mt-1 text-itve-blue flex-shrink-0" />
                      <div><span className="font-semibold text-itve-gray-dark">2015:</span> Launched first suite of online blended learning programs, expanding reach to remote students. Introduced digital literacy courses.</div>
                    </li>
                    <li className="flex items-start">
                       <Users2 className="h-5 w-5 mr-3 mt-1 text-itve-blue flex-shrink-0" />
                      <div><span className="font-semibold text-itve-gray-dark">2020:</span> Surpassed 500,000 student enrollments across all programs. Opened second major campus.</div>
                    </li>
                    <li className="flex items-start">
                       <CheckCircle className="h-5 w-5 mr-3 mt-1 text-itve-blue flex-shrink-0" />
                      <div><span className="font-semibold text-itve-gray-dark">2024:</span> Forged a strategic academic partnership with Karachi University for joint degree programs and research initiatives. Launched AI & Robotics department.</div>
                    </li>
                  </ul>
                  <p className="mt-6">Today, ITVE stands as a beacon of hope and opportunity, deeply committed to shaping skilled, adaptable professionals prepared for the dynamic challenges of the future. We continue to innovate and expand, always with our students' success at the heart of our mission.</p>
                </CardContent>
              </Card>
            </motion.div>
          </Section>
